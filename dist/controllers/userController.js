...
export const userSignup = async (req, res, next) => {
    try {
        ...
        const result = await pool.query("INSERT INTO users (name, email, password_hash, created_at, updated_at) VALUES ($1, $2, $3, NOW(), NOW()) RETURNING *", [name, email, hashedPassword]);
